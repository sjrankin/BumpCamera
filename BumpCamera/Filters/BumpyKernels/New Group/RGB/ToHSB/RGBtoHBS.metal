...
// Compute kernel
kernel void RGBtoHBS(texture2d<half, access::read>  inputTexture  [[ texture(0) ]],
                     ...
                     uint2 gid [[thread_position_in_grid]])
{
    ...
    half4 outputColor = half4(H * Strengths.Hue, L * Strengths.Brightness, S * Strengths.Saturation, 1.0);
