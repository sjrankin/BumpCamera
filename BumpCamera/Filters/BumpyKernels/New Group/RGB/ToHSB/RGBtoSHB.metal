...
// Compute kernel
kernel void RGBtoSHB(texture2d<half, access::read>  inputTexture  [[ texture(0) ]],
                     ...
                     uint2 gid [[thread_position_in_grid]])
{
    ...
    half4 outputColor = half4(S * Strengths.Saturation, H * Strengths.Hue, L * Strengths.Brightness, 1.0);
