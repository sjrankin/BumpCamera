...
// Compute kernel
kernel void RGBtoBSH(texture2d<half, access::read>  inputTexture  [[ texture(0) ]],
                     ...
                     uint2 gid [[thread_position_in_grid]])
{
    ...
    half4 outputColor = half4(L * Strengths.Brightness, S * Strengths.Saturation, H * Strengths.Hue, 1.0);
