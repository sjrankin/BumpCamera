...
// Compute kernel
kernel void RGBtoBHS(texture2d<half, access::read>  inputTexture  [[ texture(0) ]],
                     ...
                     uint2 gid [[thread_position_in_grid]])
{
    ...
    half4 outputColor = half4(L * Strengths.Brightness, H * Strengths.Hue, S * Strengths.Saturation, 1.0);
