...
// Compute kernel
kernel void RGBtoHSB(texture2d<half, access::read>  inputTexture  [[ texture(0) ]],
                     ...
                     uint2 gid [[thread_position_in_grid]])
{
    ...
    half4 outputColor = half4(H * Strengths.Hue, S * Strengths.Saturation, L * Strengths.Brightness, 1.0);
