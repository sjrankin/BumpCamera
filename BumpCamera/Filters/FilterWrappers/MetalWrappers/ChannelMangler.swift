...
class ChannelMangler: FilterParent, Renderer
{
    ...
    static let _ID: UUID = UUID(uuidString: "45c70879-3fcf-4ca1-a563-e9fa5b7d59e0")!
    ...
    var Description: String = "ChannelMangler"
    ...
    func Initialize(With FormatDescription: CMFormatDescription, BufferCountHint: Int)
    {
        ...
        {
            fatalError("Unable to allocation texture cache in ChannelMangler.")
        }
        else
        {
    ...
    func Render(PixelBuffer: CVPixelBuffer) -> CVPixelBuffer?
    {
        ...
        {
            print("Allocation failure for new pixel buffer pool in ChannelMangler.")
            return nil
        }
        ...
        {
            print("Error creating textures in ChannelMangler.")
            return nil
        }
    ...
    func Render(Image: UIImage) -> UIImage?
    {
        ...
        {
            print("Error creating input texture in ChannelMangler.Render.")
            return nil
        }
    ...
    func Render(Image: CIImage) -> CIImage?
    {
        ...
        if let IFinal = Render(Image: UImage)
        {
            ...
            {
                print("Error converting UIImage to CIImage in ChannelMangler.Render(CIImage)")
                return nil
            }
        }
        else
    ...
    {
        return "ChannelManglerSettingsUI"
    }
    ...
    {
        var Keywords = [String]()
        Keywords.append("Filter: ChannelMangler")
