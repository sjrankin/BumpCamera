...
class AlphaBlend: FilterParent, Renderer
{
    ...
    static let _ID: UUID = UUID(uuidString: "c32c060c-3067-47ea-9044-ac37046aef51")!
    ...
    var Description: String = "AlphaBlend"
 ...
 */
    ...
    func RenderWith(Images: [UIImage], AltSettings: FilterSettingsBlob) -> UIImage?
    {
        ...
        for Image in Images
        {
            ...
            {
                print("Error creating input texture in AlphaBlend.Render.")
                return nil
            }
    ...
    {
        var Keywords = [String]()
        Keywords.append("Filter: AlphaBlend")
