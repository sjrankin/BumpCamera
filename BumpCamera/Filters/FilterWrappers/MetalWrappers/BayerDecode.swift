...
class BayerDecode: FilterParent, Renderer
{
    ...
    static let _ID: UUID = UUID(uuidString: "1d91a659-2b81-4b2d-84b3-2f96eaadbe23")!
    
    func ID() -> UUID
    {
        return BayerDecode._ID
    }
    ...
    var Description: String = "BayerDecode"
    
    var IconName: String = "BayerDecode"
    ...
    func Render(PixelBuffer: CVPixelBuffer) -> CVPixelBuffer?
    {
        ...
        if !Initialized
        {
            fatalError("BayerDecode not initialized at Render(CVPixelBuffer) call.")
        }
        ...
        {
            print("Allocation failure for new pixel buffer pool in BayerDecode.")
            return nil
        }
        ...
        {
            print("Error creating textures in BayerDecode.")
            return nil
        }
    ...
    func Render(Image: UIImage) -> UIImage?
    {
        ...
        {
            print("Error creating input texture in BayerDecode.Render.")
            return nil
        }
    ...
    func Render(Image: CIImage) -> CIImage?
    {
        ...
        if let IFinal = Render(Image: UImage)
        {
            ...
            {
                print("Error converting UIImage to CIImage in BayerDecode.Render(CIImage)")
                return nil
            }
        }
        else
        {
            print("Error returned from Render(UIImage) in BayerDecode.Render(CIImage)")
            return nil
        }
    }
    ...
    func DefaultFieldValue(Field: FilterManager.InputFields) -> (FilterManager.InputTypes, Any?)
    {
        ...
        default:
            fatalError("Encountered unexpected input field: \(Field).")
        }
    }
    
    func SupportedFields() -> [FilterManager.InputFields]
    {
        return BayerDecode.SupportedFields()
    }
    
    public static func SupportedFields() -> [FilterManager.InputFields]
    {
        var Fields = [FilterManager.InputFields]()
        Fields.append(.BayerPattern)
        Fields.append(.BayerDecodeMethod)
    ...
    {
        return BayerDecode.SettingsStoryboard()
    }
    ...
    {
        return BayerDecode.FilterTarget()
    }
    ...
    {
        var Keywords = [String]()
        Keywords.append("Filter: BayerDecode")
    ...
    var FilterKernel: FilterManager.FilterKernelTypes
    {
        get
        {
            return BayerDecode.FilterKernel
        }
    }
