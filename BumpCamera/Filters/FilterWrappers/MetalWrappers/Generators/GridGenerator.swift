...
class GridGenerator: FilterParent, Renderer
{
    required override init()
    {
        let DefaultLibrary = MetalDevice?.makeDefaultLibrary()
        let KernelFunction = DefaultLibrary?.makeFunction(name: "GridGenerator")
        do
        {
    ...
    var Description: String = "GridGenerator"
    
    var IconName: String = "GridGenerator"
    ...
    func Initialize(With FormatDescription: CMFormatDescription, BufferCountHint: Int)
    {
        ...
        {
            fatalError("Unable to allocation texture cache in GridGenerator.")
        }
        else
        {
    ...
    func Render(PixelBuffer: CVPixelBuffer) -> CVPixelBuffer?
    {
        ...
        {
            print("Allocation failure for new pixel buffer pool in GridGenerator.")
            return nil
        }
        ...
        {
            print("Error creating textures in GridGenerator.")
            return nil
        }
    ...
    func Render(Image: UIImage) -> UIImage?
    {
        ...
        {
            print("Error creating input texture in GridGenerator.Render.")
            return nil
        }
    ...
    func Render(Image: CIImage) -> CIImage?
    {
        ...
        if let IFinal = Render(Image: UImage)
        {
            ...
            {
                print("Error converting UIImage to CIImage in GridGenerator.Render(CIImage)")
                return nil
            }
        }
        else
    ...
    {
        return GridGenerator.SupportedFields()
    }
    ...
    {
        return GridGenerator.SettingsStoryboard()
    }
