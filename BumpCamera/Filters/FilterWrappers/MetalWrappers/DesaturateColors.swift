...
class DesaturateColors: FilterParent, Renderer 
{
    ...
    var Description: String = "Desaturate"
    
    var IconName: String = "Desaturate"
    ...
    func Initialize(With FormatDescription: CMFormatDescription, BufferCountHint: Int)
    {
        ...
        {
            fatalError("Unable to allocation texture cache in DesaturateColors.")
        }
        else
        {
    ...
    func Render(PixelBuffer: CVPixelBuffer) -> CVPixelBuffer?
    {
        ...
        if !Initialized
        {
            fatalError("DesaturateColors not initialized at Render(CVPixelBuffer) call.")
        }
        ...
        {
            print("Allocation failure for new pixel buffer pool in DesaturateColors.")
            return nil
        }
        ...
        {
            print("Error creating textures in DesaturateColors.")
            return nil
        }
        ...
        CommandEncoder.label = "Desaturate Colors"
    ...
    func Render(Image: CIImage) -> CIImage?
    {
        ...
        if let IFinal = Render(Image: UImage)
        {
            ...
            {
                print("Error converting UIImage to CIImage in DesaturateColors.Render(CIImage)")
                return nil
            }
        }
        else
    ...
    {
        return DesaturateColors.FilterTarget()
    }
    ...
    {
        var Keywords = [String]()
        Keywords.append("Filter: DesaturationKernel")
