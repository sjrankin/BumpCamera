...
class HalfAndHalf: FilterParent, Renderer
{
    static let _ID: UUID = UUID(uuidString: "ceaffa1a-7bb9-4b44-8670-fba3d7acea03")!
    ...
    var Description: String = "HalfAndHalf"
    ...
    func DefaultFieldValue(Field: FilterManager.InputFields) -> (FilterManager.InputTypes, Any?)
    {
        ...
        case .HaHBottomFilter:
            return (.IntType, 0 as Any?)
            
        case .HaHLeftFilterBlob:
            return (.StringType, "" as Any?)
            
        case .HaHRightFilterBlob:
            return (.StringType, "" as Any?)
            
        case .HaHTopFilterBlob:
            return (.StringType, "" as Any?)
            
        case .HaHBottomFilterBlob:
            return (.StringType, "" as Any?)
    ...
    public static func SupportedFields() -> [FilterManager.InputFields]
    {
        return [.RenderImageCount, .CumulativeImageRenderDuration, .RenderLiveCount, .CumulativeLiveRenderDuration,
                .HaHOrientation, .HaHBlending, .HaHTopFilter, .HaHBottomFilter, .HaHLeftFilter, .HaHRightFilter,
                .HaHTopFilterBlob, .HaHBottomFilterBlob, .HaHLeftFilterBlob, .HaHRightFilterBlob]
    }
    ...
    {
        return "HalfAndHalfFilterSettingsUI"
    }
    ...
    {
        var Keywords = [String]()
        Keywords.append("Filter: HalfAndHalf")
        Keywords.append("FilterType: Varies")
    ...
    static var FilterKernel: FilterManager.FilterKernelTypes
    {
        get
        {
            return FilterManager.FilterKernelTypes.Combined
        }
    }
