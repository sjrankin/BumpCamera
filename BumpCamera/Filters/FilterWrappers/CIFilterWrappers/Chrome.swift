...
class Chrome: FilterParent, Renderer
{
    static let _ID: UUID = UUID(uuidString: "2df62fda-1330-4844-8aca-64a6d6c83eaf")!
    ...
    var Description: String = "Chrome"
    
    var IconName: String = "Chrome"
    ...
    func Render(PixelBuffer: CVPixelBuffer) -> CVPixelBuffer?
    {
        ...
        {
            print("Allocation failure in Chrome.")
            return nil
        }
    ...
    {
        return Chrome.SettingsStoryboard()
    }
