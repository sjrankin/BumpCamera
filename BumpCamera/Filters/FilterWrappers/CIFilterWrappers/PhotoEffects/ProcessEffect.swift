...
class ProcessEffect: FilterParent, Renderer
{
    static let _ID: UUID = UUID(uuidString: "e0ebdd28-3f87-416a-8667-9c5d570bec96")!
    
    func ID() -> UUID
    {
        return ProcessEffect._ID
    }
    ...
    var Description: String = "Process Effect"
    
    var IconName: String = "Process Effect"
    ...
    {
        Reset("ProcessEffect.Initialize")
        ...
        Context = CIContext()
        PrimaryFilter = CIFilter(name: "CIPhotoEffectProcess")
        Initialized = true
    }
    ...
    func Render(PixelBuffer: CVPixelBuffer) -> CVPixelBuffer?
    {
        ...
        {
            print("Allocation failure in ProcessEffect.")
            return nil
        }
    ...
    {
        return ProcessEffect.SupportedFields()
    }
    ...
    {
        return ProcessEffect.SettingsStoryboard()
    }
    ...
    {
        return ProcessEffect.FilterTarget()
    }
    ...
    {
        var Keywords = [String]()
        Keywords.append("Filter: CIPhotoEffectProcess")
    ...
    var FilterKernel: FilterManager.FilterKernelTypes
    {
        get
        {
            return ProcessEffect.FilterKernel
        }
    }
