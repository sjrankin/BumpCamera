...
class Vibrance: FilterParent, Renderer
{
    static let _ID: UUID = UUID(uuidString: "48e3cf22-e75a-4ee0-b8f3-904c9b9210b0")!
    ...
    var Description: String = "Vibrance"
    
    var IconName: String = "Vibrance"
    ...
    func Initialize(With FormatDescription: CMFormatDescription, BufferCountHint: Int)
    {
        ...
        Context = CIContext()
        PrimaryFilter = CIFilter(name: "CIVibrance")
        Initialized = true
    }
    ...
    func Render(PixelBuffer: CVPixelBuffer) -> CVPixelBuffer?
    {
        ...
        let Amount = ParameterManager.GetDouble(From: ID(), Field: .Amount, Default: 0.0)
        
        PrimaryFilter.setValue(Amount, forKey: "inputAmount")
        ...
        {
            print("Allocation failure in Vibrance.")
            return nil
        }
    ...
    {
        return Vibrance.SupportedFields()
    }
    ...
    {
        return Vibrance.SettingsStoryboard()
    }
    
    public static func SettingsStoryboard() -> String?
    {
        return "VibranceSettingsUI"
    }
    ...
    {
        var Keywords = [String]()
        Keywords.append("Filter: CIVibrance")
