...
class TonalEffect: FilterParent, Renderer
{
    static let _ID: UUID = UUID(uuidString: "46068424-35f2-4b51-a240-327c3ca19f57")!
    ...
    var IconName: String = "Tonal"
    
    var Description: String = "Tonal"
    ...
    func Initialize(With FormatDescription: CMFormatDescription, BufferCountHint: Int)
    {
        ...
        Context = CIContext()
        PrimaryFilter = CIFilter(name: "CIPhotoEffectTonal")
        Initialized = true
    }
    ...
    {
        var Keywords = [String]()
        Keywords.append("Filter: CIFilterEffectTonal")
