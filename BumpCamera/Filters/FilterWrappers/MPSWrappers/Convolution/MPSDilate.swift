...
class MPSDilate: FilterParent, Renderer
{
    ...
    static let _ID: UUID = UUID(uuidString: "1a457417-c2c5-4a8a-8980-71325235fc9c")!
    ...
    var Description: String = "MPSDilate"
    ...
    func Initialize(With FormatDescription: CMFormatDescription, BufferCountHint: Int)
    {
        ...
        {
            fatalError("Unable to allocation texture cache in MPSDilate.")
        }
        else
        {
    ...
    func Render(PixelBuffer: CVPixelBuffer) -> CVPixelBuffer?
    {
        ...
        if !Initialized
        {
            fatalError("MPSDilate not initialized at Render(CVPixelBuffer) call.")
        }
        ...
        {
            print("Error creating Metal command queue in MPSDilate.")
...
//        Probe[CalculateCenter(Width: KWidth, Height: KHeight).0] = 0.0
    ...
    func Render(Image: CIImage) -> CIImage?
    {
        ...
        if let IFinal = Render(Image: UImage)
        {
            ...
            {
                print("Error converting UIImage to CIImage in MPSDilate.Render(CIImage)")
                return nil
            }
        }
        else
        {
            print("Error returned from Render(UIImage) in MPSDilate.Render(CIImage)")
            return nil
        }
    }
    ...
    {
        var Keywords = [String]()
        Keywords.append("Filter: MPSDilate")
